...
from core.agent import RectAgent,BaseAgent,AgentGroup,TalkDirection
...
if __name__ == "__main__":
    ...
    agent = RectAgent("alex",size=32,pos=(32,64),color=('blue'))
    agent.talk_direction = TalkDirection.LEFT
    
    tony_agent = RectAgent("tony",size=32,pos=(800,64),color=('cyan'))
    jerry_agent = RectAgent("jerry",size=32,pos=(800,480),color=('cyan'))
    agent_01 = RectAgent("agent_01",size=32,pos=(32,480),color=('cyan'))
    ...
    agent.set_target(tony_agent.rect.center,is_insert=True)
    agent.set_target(jerry_agent.rect.center,is_insert=True)
    agent.set_target(agent_01.rect.center,is_insert=True)
    agent.set_target(pygame.Rect(32,64,32,32).center,is_insert=True)
