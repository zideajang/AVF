...
from core.task import DelayTask,MoveToTask
GRID_W = 30
GRID_H = 20
GRID_SIZE = 32
UI_WIDTH = 256
...
if __name__ == "__main__":
    ...
    agent.add_task(DelayTask(duration_sec=5.0, name="delay_task"))
    agent.add_task(MoveToTask(name="move_to_jerry",target_pos=jerry_agent.rect.center,stop_distance=16))
